...
//                        ZStack {
//                            Circle()
//                                .stroke(Color.green, style: StrokeStyle(lineWidth: tapButtonStatus[0] ? 20 : 0))
...
//                ZStack {
//                    Circle()
//                        .stroke(Color.green, style: StrokeStyle(lineWidth: tapButtonStatus[1] ? 20 : 0))
//                        .frame(width: 240, height: 240)
//                        .opacity(0.8)
//                        .animation(.easeIn(duration: 0.3), value: tapButtonStatus)
//                    
...
//                ZStack {
//                    Circle()
//                        .stroke(Color.green, style: StrokeStyle(lineWidth: tapButtonStatus[2] ? 20 : 0))
//                        .frame(width: 240, height: 240)
//                        .opacity(0.8)
//                        .animation(.easeIn(duration: 0.3), value: tapButtonStatus)
//                    
...
//                    ZStack{
//                        Circle()
//                            .stroke(Color.green, style: StrokeStyle(lineWidth: tapButtonStatus[3] ? 20 : 0))
//                            .frame(width: 240, height: 240)
//                            .opacity(0.8)
//                            .animation(.easeIn(duration: 0.3), value: tapButtonStatus)
//                        
...
//                ZStack{
//                    Circle()
//                        .stroke(Color.green, style: StrokeStyle(lineWidth: tapButtonStatus[4] ? 20 : 0))
//                        .frame(width: 240, height: 240)
//                        .opacity(0.8)
//                        .animation(.easeIn(duration: 0.3), value: tapButtonStatus)
//                    
...
//}
//
//struct SplashScreen2_Preview: PreviewProvider {
